...
gg <- df_anime %>% 
    ...
    theme(
        ...
        axis.title.x = element_text(color = '#34495e', size = 18),
        ...
        axis.title.y = element_text(color = '#34495e', size = 18),
        plot.title = element_text(hjust = 0, color = '#34495e', face = 'bold', size = 26),
        plot.subtitle = element_text(hjust = 0, color = '#34495e', size = 22),
    ...
    theme(
        strip.text.x = element_text(color = "#34495e", size = 16, face = 'bold'),
